...
#     instantiated with args that are not kwargs
#         instantiated with *args
#         instantiated with regular args
#     passing a non-dict to **kwargs
#     passing **kwargs which lack the core attributes. id and the rest
...
class TestBaseModel(unittest.TestCase):
    ...
    def setUp(cls):
        ...
        cls.class_dict = {
                "id": "c379e631-759b-4b91-a65b-7bff93f04d06",
                "created_at": "2023-02-10T17:15:32.858581",
                "updated_at": "2023-02-10T17:15:32.858590",
                "name": "My_First_Model",
                "my_number": 89,
                "__class__": "BaseModel"
                }
 
        cls.BaseModel2 = BaseModel(**cls.class_dict)
    ...
    def testKwargsInitialisation(self):
        self.assertEqual(self.BaseModel2.name, self.class_dict["name"])
        self.assertEqual(self.BaseModel2.my_number, self.class_dict['my_number'])
        self.assertEqual(self.BaseModel2.id, self.class_dict['id'])
